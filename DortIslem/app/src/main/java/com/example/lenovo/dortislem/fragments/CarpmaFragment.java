 ...
 */
public class CarpmaFragment extends Fragment {
    public CarpmaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view =inflater.inflate(R.layout.fragment_carpma, container, false);
        final TextView t1 =view.findViewById(R.id.sayi1);
        t1.setText(String.valueOf(giveFirstNumber()));
        setupUI(view);
        final TextView t2 =view.findViewById(R.id.sayi2);
        t2.setText(String.valueOf(giveSecondNumber()));

        final TextView tS =view.findViewById(R.id.dogruSonuc);

        final EditText sonuccevabi =view.findViewById(R.id.sonuc);



        Button button2 = view.findViewById(R.id.dogruyugöster);
